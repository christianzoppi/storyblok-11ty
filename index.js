        ...
        return new Promise((resolve, reject) => {
            ...
            .catch(err => {
                ...
                switch(err.response.status) {
                    case 401:
                        console.error('\x1b[31mError 401: Unauthorized. Probably the API token is wrong.\x1b[0m');
                        break;
                    case 404:
                        console.error('\x1b[31mError 404: The item you are trying to get doesn\'t exit.\x1b[0m');
                        break;
                    default:
...
module.exports = StoryblokTo11ty;